...
export default function Home() {
  ...
  return <div className="site-wrap">
    ...
    {panel && <Modal panel={panel} close={() => setPanel(null)} />}
  </div>;
}
